...
const Feature166 = ({
  ...
  description =
    "Hand-picked properties from verified agents and owners, updated in real time so you never miss a good deal.",
  listings,
  className,
}: Feature166Props) => {
  return (
    <section className={cn("py-24 flex justify-center", className)} id="featured">
      <div className="container">
        {/* Heading */}
        ...
        <div className="mb-24 flex flex-col items-center gap-6">
          ...
          <p className="text-center text-lg text-muted-foreground md:max-w-4xl lg:text-xl">
            {description}
          </p>
        </div>
        ...
        {/* <div className="flex flex-nowrap w-full overflow-x-auto gap-3 scrollbar-thin"> */}
